...
export default function IMPage() {
  ...
  return <main className="im-shell">
    ...
    {activeGroup && <div className="group-quick-actions"><button onClick={() => setShowGroupInfo(true)}>群成员</button><button onClick={() => void openGroupSummary()}>群摘要</button><button disabled={groupReplying} onClick={startNewGroupConversation}>＋ 新会话</button></div>}
    {view === 'chat' ? <>
